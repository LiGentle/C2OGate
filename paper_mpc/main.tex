...
We timed the complete $H=3$ generic path above, including the conic search,
rational reconstruction, and five independent verifier processes.  On the
recorded machine, search plus the median verification charge took
...
zero-credit online decision.}
\label{tab:certificate-cost}
\begin{tabular}{rrr}
\toprule
Exact-oracle seconds $t_f$ & One-use certificate units & Minimum reuses $K$\\
\midrule
$10^{-4}$ & $1.489\times10^4$ & \CertificateBreakEvenTinyOracle{}\\
$1$       & $1.489$            & \CertificateBreakEvenOneSecond{}\\
$10$      & $0.149$            & \CertificateBreakEvenTenSecond{}\\
$60$      & $0.025$            & \CertificateBreakEvenSixtySecond{}\\
\bottomrule
\end{tabular}
\end{table}
